...
GET_STATIONS = "SELECT id, name, description, active_configuration_id FROM stations"
GET_STATION = "SELECT id, name, description, active_configuration_id FROM stations WHERE id = :id"
CREATE_STATION = """
    INSERT INTO stations (id, name, description, active_configuration_id)
    VALUES (:id, :name, :description, :active_configuration_id)
"""
UPDATE_STATION = """
    UPDATE stations
    SET name = :name, description = :description, active_configuration_id = :active_configuration_id
    WHERE id = :id
"""
